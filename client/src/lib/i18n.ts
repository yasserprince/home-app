...
export const translations = {
  en: {
    ...
    roleSeekerDesc: 'I need services for my home',
    roleProvider: 'Service Provider',
    roleProviderDesc: 'I provide services to customers',
    roleCompany: 'Service Company',
    roleCompanyDesc: 'I run a service business',
